...
public class Mujer {
    ...
    @Column(name = "id_mujer")
    private Integer idMujer;

    @Column(name = "talla", nullable = false)
    private String talla;

    @Column(name = "busto_cm")
...
private Integer cantidadTalla;
    ...
    // Getters y Setters
    public Integer getIdMujer() { return idMujer; }
    public void setIdMujer(Integer idMujer) { this.idMujer = idMujer; }
